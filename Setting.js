...
global.mongodb = process.env.MONGODB_URI || "mongodb_83b41f37-00bf-453e-80d2-0e9cb9c9ff81" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.mztit = process.env.MZTIT ||"It'X Chandi♤ ",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '19_04_2024_SIGMA_MD_J5HHBket_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
